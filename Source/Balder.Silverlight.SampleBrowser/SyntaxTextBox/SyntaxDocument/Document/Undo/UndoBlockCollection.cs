...
/// <param name="array"></param>
		...
		private void ValidateIndex(int index, bool allowEqualEnd)
		{
			...
			if (index < 0 || index > max)
				throw new ArgumentOutOfRangeException("index", "Index was out of range.  Must be non-negative and less than the size of the collection.");// "Specified argument was out of the range of valid values.");
		}
