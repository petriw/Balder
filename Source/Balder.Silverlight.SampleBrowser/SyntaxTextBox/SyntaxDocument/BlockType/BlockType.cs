...
namespace Fireball.Syntax
{
	...
	public class BlockType
	{
		...
		public Dictionary<object, PatternCollection> LookupTable = new Dictionary<object, PatternCollection>();
    private List<Pattern> tmpSimplePatterns = new List<Pattern>();
		...
		{
			IComparer<Pattern> comparer = new PatternComparer();
            ...
            if (LookupTable.ContainsKey(c1) == false)
            ...
            if (LookupTable.ContainsKey(c2) == false)
					...
					{
            if (LookupTable.ContainsKey(c) == false)
